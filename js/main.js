...
function initScene() {
  ...
  camera = new THREE.PerspectiveCamera(45, params.width / params.height, 0.1);
...
function throwDice(serverSeed) {
  ...
  diceArray.forEach((d, dIdx) => {
    ...
    d.body.position = new CANNON.Vec3(6, dIdx * (params.diceSize * 1.5), 0);
